...
class DESSample
{
    static void Main()
    {
        ...
        {
            Console.WriteLine("------------------------------------------------------------------");
            Console.WriteLine("|        DATA ENCRYPTION STANDARD (DES) ENCRYPTION SCHEME        |");
            Console.WriteLine("------------------------------------------------------------------\n");

            Console.Write("\nEnter a String to generate 56-bits Key: ");
            String str = Console.ReadLine();
            string mysecurityKey = GetUniqueToken(8, str);
            ...
            while (opt == "y")
            {
                ...
                Console.WriteLine("Generated 56-bit Key (Base-64): {0}", Encoding.UTF8.GetString(key));
                Console.WriteLine("Generated 56-bit Key (Hex): {0}", BitConverter.ToString(key));
